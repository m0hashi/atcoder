...
// CUT begin
	public static void main(String[] args){
		System.err.println("PalindromeSubsequence (250 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1654511056;
	...
	static boolean doTest(String s, int[] __expected) {
		...
		try {
			__result = instance.optimalPartition(s);
		}
	...
	static class Reader {
        private static final String dataFileName = "PalindromeSubsequence.sample";
